<template>
    <div class="centered">
        ...
        <p>
            Wij vinden het belangrijk om het te hebben over Satoshi in plaats
            van Bitcoin. Veel mensen weten namelijk niet dat een Bitcoin
            überhaupt deelbaar is. Omdat het nog een beetje lastig is om snel de
            waarde van 1 Euro in Satoshi om te zetten, hebben we deze website
            gemaakt.
        </p>
...
export default {
    ...
    mounted() {
        ...
        fetch(
            "https://api.blockchain.com/v3/exchange/tickers/BTC-EUR?cors=true"
        )
    ...
    methods: {
        onChangeEur() {
            console.log("onchangeeur", this.eur);
            this.sat = (this.eur * this.rate).toFixed(0);

            this.setURL();

            this.lastChanged = "eur";
        },
        onChangeSat() {
